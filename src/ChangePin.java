...
public class ChangePin implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == back_Button) {
            ...
            if (!validatePin(oldPin) || !validatePin(newPin) || !validatePin(renew) || (!newPin.equals(renew))) {
                ...
                if (!validatePin(oldPin)) {
                    error_Label = new JLabel("Enter valid 4-digit old pin");
                } else if (!validatePin(newPin) || !validatePin(renew)) {
                    error_Label = new JLabel("Enter valid 4-digit new pin");
